    ...
    public class AccountController:Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            if(result.Succeeded)
            {
                ...
                // email
                await _emailSender.SendEmailAsync(model.Email,"Verify your account.",$"Press the link for verify your account <a href='https://127.0.0.1:5001{url}'>tıklayınız.</a>");
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            TempData.Put("message", new AlertMessage()
            {
                ...
                Message="Your account has been closed securely.",
                AlertType="warning"
            });
            return Redirect("~/");
        }
            ...
            if(user!=null)
            {
                ...
                if(result.Succeeded)
                {
                    ...
                    TempData.Put("message", new AlertMessage()
                    {
                        ...
                        Message="Your account is confirmed.Now, you can login!",
                        AlertType="success"
                    });
                    return View();
                }
